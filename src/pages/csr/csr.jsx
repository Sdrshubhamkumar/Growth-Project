      ...
      <div>
        ...
        <div className="text-container text-[#838383] p-20 pt-15 pb-15">
          <p className="mb-4">
            ...
            initiatives that create lasting social impact. Every contribution is
            a step toward sustainable development—ethically managed,
            transparently reported, and community-driven
          </p>
          ...
          <div className="mb-4 space-y-4">
            ...
            <p>
              ...
              Working alongside NGOs, corporations, and beneficiaries for
              scalable solutions.
            </p>
            <p>
          ...
          <p className="mb-4">
            When you invest in Swikar, you invest in a future which is built on trust of the community, accountability, equity, and most importantly change that affect the lives of millions in real time.
          </p>
        </div>
      </div>
    </div>
