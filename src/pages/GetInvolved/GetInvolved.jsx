  ...
  return (
    <div className="bg-gray-50 py-12 px-4 md:px-12 lg:px-24">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12 bg-white rounded-xl shadow-md p-6">
        <img
          src={ab}
          alt="Internships at Swikar Charitable"
          className="rounded-lg object-cover w-full h-auto"
        />
        <div>
          <h2 className="text-2xl font-semibold text-purple-700 mb-4">
            Internships at Swikar Charitable
          </h2>
          <p className="mb-2">
            Swikar Charitable Charitable Trust offers immersive internship opportunities for students and professionals interested in urban development, education, health, child rights, governance, and more.
          </p>
          <p className="mb-4">
            To apply for internships, send the following to{" "}
            <span className="text-blue-600 font-medium">mail@Swikar Charitable.org</span>:
          </p>
          ...
          <a
            href="https://Swikar Charitable.org/assets/Internship_Form_Swikar Charitable.docx"
      ...
      <div className="bg-white shadow-md rounded-xl p-6 mb-16">
        ...
        <ul className="list-disc list-inside text-sm space-y-1">
          <li>The subject line for the email should be: Internship at Swikar Charitable | Your name | Institute</li>
          <li>All the documents mentioned above need to be attached</li>
          <li>Field work will be compulsory for all interns</li>
          <li>No stipend/housing provided by Swikar Charitable</li>
          ...
          <li>Swikar Charitable shall not be liable for any accidents or injuries during field work</li>
        </ul>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12 bg-white rounded-xl shadow-md p-6">
        <div>
          <h2 className="text-2xl font-semibold text-purple-700 mb-4">
            Volunteering at Swikar Charitable
          </h2>
          <p className="mb-2">
            Volunteering at Swikar Charitable allows you to make a real impact in the lives of the urban poor. You can contribute on-ground or remotely to a variety of causes.
          </p>
          <p className="mb-2">
          ...
          <a
            href="https://Swikar Charitable.org/assets/Volunteering_Form_Swikar Charitable.docx"
            className="text-blue-600 underline text-sm"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <img
          src={img2}
          alt="Volunteering at Swikar Charitable"
          className="rounded-lg object-cover w-full h-auto"
        />
      </div>
      ...
      <div className="bg-white shadow-md rounded-xl p-6">
        ...
        <ul className="list-disc list-inside text-sm space-y-1">
          <li>Email subject: Volunteering at Swikar Charitable | Your Name</li>
          ...
          <li>Swikar Charitable will assign roles based on need and availability</li>
          <li>Weekly reports must be submitted</li>
          <li>Certificates issued upon successful review</li>
          <li>Swikar Charitable shall not be liable for accidents or injuries during field work</li>
        </ul>
      </div>
    </div>
  );
